                    ...
                    <div class="card-header">
                    	<div class="row">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 text-end">
                                <button type="button" name="addPurchase" id="addPurchase" class="btn btn-primary btn-sm rounded-0"><i class="far fa-plus-square"></i> Adicionar Compra</button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title"><i class="fa fa-plus"></i> Adicionar Compra</h4>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-default border btn-sm rounded-0" data-bs-dismiss="modal">Fechar</button>
                        </div>
                    </div>
            </div>
        </div>
