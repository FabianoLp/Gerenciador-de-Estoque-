...
if (!empty($_POST['email']) && !empty($_POST['pwd'])) {
	...
	if(!empty($login)) {
		...
		$loginError = "O e-mail ou senha estão incorretos!";
	}
}
?>
<style>
				...
				<div class="container-fluid">
					<form method="post" action="">
						...
						<div class="mb-3">
							...
							<input name="email" id="email" type="email" class="form-control rounded-0" placeholder="Digite o e-mail" autofocus="" value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>" required>
						</div>
						<div class="mb-3">
							<label for="password" class="control-label">Senha</label>
							<input type="password" class="form-control rounded-0" id="password" name="pwd" placeholder="Senha" required>
						</div>  
						<div class="d-grid">
